...
public class ProjectController {
    ...
    @PostMapping("/create")
    @PreAuthorize("hasRole('ROLE_USER')")
    public ResultVo createProject(@RequestAttribute String uid, String name, String description,HttpServletRequest request) {

        // 写入日志
        SysLogService logService = SpringBeanFactoryUtils.getBean(SysLogService.class);
        logService.saveLog(request, LogTypeEnum.CREATE_PROJECT.getCode());
